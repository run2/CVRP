...
public class FruityBunNodes {
	...
	static{
		for(int i = 2 ; i < coords.length; i ++){
			nodes.add(new Node(Integer.toString(i)  ,coords[i][0] , coords[i][1]));
			totalDemand+=demand[i];
		}
		nodes.add(new Node("D1"  ,coords[1][0] , coords[1][1]));
		nodes.get(nodes.size()-1).setName("1");
		nodes.add(new Node("D2"  ,coords[1][0] , coords[1][1]));
		nodes.get(nodes.size()-1).setName("1");
		nodes.add(new Node("D3"  ,coords[1][0] , coords[1][1]));
		nodes.get(nodes.size()-1).setName("1");
		nodes.add(new Node("D4"  ,coords[1][0] , coords[1][1]));
		nodes.get(nodes.size()-1).setName("1");
		nodes.add(new Node("D5"  ,coords[1][0] , coords[1][1]));
		nodes.get(nodes.size()-1).setName("1");
		nodes.add(new Node("D6"  ,coords[1][0] , coords[1][1]));
		nodes.get(nodes.size()-1).setName("1");
